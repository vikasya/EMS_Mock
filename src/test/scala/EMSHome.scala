...
class EMSHome extends Simulation {
  ...
  val scn = scenario("EMS Scenario")
    ...
    .exec(http("request_add")
      .post("http://172.27.59.114:8012/EmployeeApplication/jsp/add.jsp")
    ...
    .exec(http("request_edit")
      .get("http://172.27.59.114:8012/EmployeeApplication/edit/6"))
    .pause(1)
    .exec(http("request_edit submit")
      .post("http://172.27.59.114:8012/EmployeeApplication/jsp/edit.jsp")
      .param("""code""", """1""")
      .param("""name""", """b""")
      .param("""city""", """c"""))
    .pause(1)
    .exec(http("request_delete")
      .get("http://172.27.59.114:8012/EmployeeApplication/jsp/delete.jsp?code=2"))
    .pause(10)
    .exec(http("request_delete submit")
      .post("http://172.27.59.114:8012/EmployeeApplication/jsp/delete.jsp")
      .param("""code""", """1"""))
